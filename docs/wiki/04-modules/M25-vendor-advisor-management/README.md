# M25 Vendor and Advisor Management

## 1. Назначение модуля
Управление поставщиками услуг и внешними advisors.
...
**Value outcomes:**
- Centralized vendor and advisor registry
- SLA monitoring with performance scorecards
...
**Vendor**
- Поля: id, name, type, category, status, contractIds[], riskTier, lastReview
- Связи: через objectRef / foreignKey

**VdContract**
- Поля: id, vendorId, title, startDate, endDate, value, autoRenew, status
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m25/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-25.json`
- Коллекции: `vdVendors`, `vdContracts`, `vdSlas`, `vdScorecards`, `vdIncidents`, `vdInvoices`
...
- **Consumers:** M13 Fees, M26 Contracts
