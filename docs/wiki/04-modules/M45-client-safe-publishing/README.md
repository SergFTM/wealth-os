# M45 Client Safe Publishing

## 1. Назначение модуля
Управление публикациями для клиентского портала.
...
**Value outcomes:**
- Controlled publication of reports to client portal
- Point-in-time snapshots for audit trail
- Granular field-level client-safe filtering
...
**PortalConfig**
- Поля: id, module, publishedFields[], hiddenFields[], clientRoles[], refreshFrequency
- Связи: через objectRef / foreignKey

**ClientSubscription**
- Поля: id, clientId, module, viewType, frequency, lastPublished
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m45/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-45.json`
- Коллекции: `portalConfigs`, `clientSubscriptions`, `clientPreferences`
...
- **Sources:** All modules (published data)
- **Consumers:** M55 Portal
