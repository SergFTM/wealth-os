# M28 Real Estate and Private Assets

## 1. Назначение модуля
Учёт недвижимости и личных активов с оценками.
...
**Value outcomes:**
- Real estate and personal asset registry
- Periodic valuation tracking with audit trail
...
### Маршруты
- `/m/private-assets`
- `/m/private-assets/list`
- `/m/private-assets/property/[id]`
...
- `assetValuations`
- `propertyIncomeExpenses`
- `auditEvents` (обязательно)

### Сущности (логическая модель)
**RealEstateProperty**
- Поля: id, name, type, address, purchaseDate, purchasePrice, currentValue, valuationDate, status
- Связи: через objectRef / foreignKey

**AssetValuation**
- Поля: id, assetId, date, value, method, appraiser, notes
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m28/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-28.json`
- Коллекции: `realEstateProperties`, `assetValuations`, `propertyIncomeExpenses`
...
- **Sources:** M05 Documents
- **Consumers:** M01 Net Worth, M11 Tax
