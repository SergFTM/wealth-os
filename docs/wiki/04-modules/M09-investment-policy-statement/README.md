# M09 Investment Policy Statement and Constraints

## 1. Назначение модуля
Управление инвестиционными политиками и ограничениями.
...
**Value outcomes:**
- Digital IPS with versioning
- Automated constraint monitoring and breach detection
- Waiver workflow with committee approval
...
**IpsPolicy**
- Поля: id, name, portfolioId, version, status, effectiveDate, constraints[], approvedBy
- Связи: через objectRef / foreignKey

**IpsBreach**
- Поля: id, policyId, constraintId, severity, detectedAt, currentValue, limit, status, resolution
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m09/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-09.json`
- Коллекции: `ipsPolicies`, `ipsConstraints`, `ipsBreaches`, `ipsWaivers`, `ipsVersions`
...
- **Sources:** M03 Performance, M01 Net Worth
- **Consumers:** M10 Risk, M38 Audit
- **Governance:** M28 Committee
