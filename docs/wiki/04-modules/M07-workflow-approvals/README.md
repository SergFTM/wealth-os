# M07 Workflow and Approvals

## 1. Назначение модуля
Движок процессов и согласований для всех модулей.
...
**Approval**
- Поля: id, objectRef, objectType, requestedBy, approvers[], status, decidedBy, decidedAt, comments
- Связи: через objectRef / foreignKey

**Task**
- Поля: id, title, assignee, module, objectRef, dueDate, priority, status, slaPolicy
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m07/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-07.json`
- Коллекции: `workflows`, `approvals`, `tasks`, `slaPolicies`
