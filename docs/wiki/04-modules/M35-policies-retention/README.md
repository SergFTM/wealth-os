# M35 Policies and Retention

## 1. Назначение модуля
Политики хранения данных, legal hold, privacy controls.
...
- Legal hold management with scope tracking
- Data classification and export control enforcement
...
## 4. Экранная модель
### Маршруты
- `/m/policies-retention`
- `/m/policies-retention/list`
- `/m/policies-retention/policy/[id]`
...
**DataPolicy**
- Поля: id, name, type, retentionPeriod, classification, scope, status, effectiveDate
- Связи: через objectRef / foreignKey

**SharingPolicy**
- Поля: id, name, allowedRecipients[], restrictions[], approvalRequired, active
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m35/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-35.json`
- Коллекции: `dataPolicies`, `sharingPolicies`, `policyBanners`
...
- **Sources:** M34 Consents
- **Consumers:** M05 Documents, M37 External Sharing
