# M04 Private Markets and Alternatives

## 1. Назначение модуля
Учёт альтернативных инвестиций: PE, VC, хедж-фонды, RE funds.
...
**Value outcomes:**
- Full commitment lifecycle tracking
- IRR/TVPI/DPI/RVPI metrics
...
### Маршруты
- `/m/private-capital`
- `/m/private-capital/list`
- `/m/private-capital/commitment/[id]`
...
**Commitment**
- Поля: id, fundName, vintage, committed, called, distributed, nav, irr, tvpi, dpi, status
- Связи: через objectRef / foreignKey

**CapitalCall**
- Поля: id, commitmentId, callDate, amount, dueDate, status, noticeRef
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m04/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-04.json`
- Коллекции: `commitments`, `capitalCalls`, `distributions`, `fundNAVs`, `privateHoldings`
...
- **Consumers:** M01 Net Worth, M03 Performance, M11 Tax
