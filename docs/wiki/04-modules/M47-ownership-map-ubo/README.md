# M47 Ownership Map and UBO

## 1. Назначение модуля
Визуализация структуры владения и выявление UBO.
...
- Automated UBO detection with threshold rules
- Historical ownership snapshots for compliance
...
**OwnershipNode**
- Поля: id, name, type, jurisdiction, parentLinks[], childLinks[], ownershipPct
- Связи: через objectRef / foreignKey

**OwnershipUbo**
- Поля: id, personId, entities[], totalOwnership, detectionMethod, verifiedAt
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m47/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-47.json`
- Коллекции: `ownershipNodes`, `ownershipLinks`, `ownershipUbo`, `ownershipViews`, `ownershipChanges`
...
- **Sources:** M29 Entity Management, M12 Trusts
- **Consumers:** M08 Onboarding, M38 Audit
