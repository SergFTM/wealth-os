# M44 Analytics and Insights Hub

## 1. Назначение модуля
Кросс-модульная аналитика и библиотека KPI.
...
**Value outcomes:**
- Cross-module KPI aggregation and scoring
...
**KpiDefinition**
- Поля: id, name, module, formula, unit, target, direction, frequency
- Связи: через objectRef / foreignKey

**KpiSnapshot**
- Поля: id, kpiId, value, period, trend, status, asOf
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m44/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-44.json`
- Коллекции: `kpiDefinitions`, `kpiSnapshots`, `analyticsDashboards`, `analyticsWidgets`
...
- **Sources:** All modules (KPI sources)
