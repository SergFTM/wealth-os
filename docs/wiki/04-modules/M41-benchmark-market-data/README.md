# M41 Benchmark and Market Data

## 1. Назначение модуля
Управление рыночными данными и бенчмарками.
...
**Value outcomes:**
- Centralized market data and pricing service
- Benchmark index library with custom composites
- Data freshness monitoring and stale price alerts
...
**BenchmarkIndex**
- Поля: id, name, provider, ticker, currency, lastValue, lastDate, frequency
- Связи: через objectRef / foreignKey

**PricingJob**
- Поля: id, schedule, sources[], lastRun, status, recordsUpdated, staleCount
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m41/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-41.json`
- Коллекции: `benchmarkIndices`, `pricingJobs`, `marketDataFeeds`, `fxRates`
...
- **Consumers:** M03 Performance, M10 Risk
