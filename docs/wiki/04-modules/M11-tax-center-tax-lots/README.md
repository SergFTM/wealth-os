# M11 Tax Center and Tax Lots

## 1. Назначение модуля
Управление налоговым учётом: tax lots, harvesting, дедлайны.
...
**Value outcomes:**
- Accurate tax lot tracking with cost basis methods
- Tax loss harvesting opportunity detection
- Advisor-ready tax pack generation
...
**TaxLot**
- Поля: id, securityId, acquiredDate, quantity, costBasis, method, holdingPeriod, unrealizedGain
- Связи: через objectRef / foreignKey

**TaxHarvesting**
- Поля: id, portfolioId, securityId, unrealizedLoss, estimatedSaving, replacementSecurity, status
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m11/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-11.json`
- Коллекции: `taxLots`, `taxGains`, `taxHarvesting`, `taxDeadlines`, `taxProfiles`, `taxAdvisorPacks`
...
- **Consumers:** M19 Reporting, M52 Packs
