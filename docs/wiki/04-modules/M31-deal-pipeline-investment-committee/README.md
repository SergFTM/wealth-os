# M31 Deal Pipeline and Investment Committee

## 1. Назначение модуля
Pipeline сделок от идеи до закрытия.
...
- Investment committee workflow with voting
...
**Deal**
- Поля: id, name, type, stage, leadPM, targetSize, expectedClose, status, committeeDecision
- Связи: через objectRef / foreignKey

**DealStage**
- Поля: id, dealId, stage, enteredAt, exitedAt, assignee, checklist[], status
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m31/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-31.json`
- Коллекции: `deals`, `dealStages`, `dealDocuments`, `dealApprovals`, `dealTransactions`
