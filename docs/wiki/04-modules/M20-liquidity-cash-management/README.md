# M20 Liquidity and Cash Management

## 1. Назначение модуля
Управление ликвидностью и прогнозирование денежных потоков.
...
- Liquidity stress testing and early warning alerts
...
- `/m/liquidity`
- `/m/liquidity/list`
- `/m/liquidity/forecast/[id]`
- `/m/liquidity/scenario/[id]`
- `/m/liquidity/stress/[id]`
- `/m/liquidity/alert/[id]`
...
**CashAccount**
- Поля: id, bankName, accountNumber, currency, balance, asOf, type
- Связи: через objectRef / foreignKey

**CashForecast**
- Поля: id, scenarioId, period, inflows, outflows, netCash, cumulativeCash
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m20/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-20.json`
- Коллекции: `cashAccounts`, `cashForecast`, `liquidityBuckets`, `liquidityAlerts`, `cashFlows`, `cashPositions`, `cashScenarios`, `cashStressTests`, `cashForecasts`
...
- **Sources:** M14 Integrations, M06 Payments
- **Consumers:** M01 Net Worth, M19 Reporting
- **Governance:** M10 Risk
