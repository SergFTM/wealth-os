# M10 Risk and Exposure Oversight

## 1. Назначение модуля
Мониторинг рисков и экспозиций портфеля.
...
- VaR and stress test scenarios
- Automated risk breach escalation
...
**RiskExposure**
- Поля: id, portfolioId, dimension, name, value, percentage, limit, breached, asOf
- Связи: через objectRef / foreignKey

**RiskAlert**
- Поля: id, type, severity, portfolioId, metric, threshold, currentValue, status, assignee
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m10/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-10.json`
- Коллекции: `riskExposures`, `riskConcentrations`, `riskMetrics`, `riskScores`, `riskAlerts`, `riskActions`
...
- **Sources:** M03 Performance, M14 Integrations
- **Consumers:** M09 IPS, M19 Reporting
