# M54 Consent and Privacy Center

## 1. Назначение модуля
Единый центр управления согласиями и приватностью.
...
**Value outcomes:**
- Centralized consent and privacy management
- Automated conflict detection between consents
...
**Consent**
- Поля: id, subjectId, type, purpose, scope, status, grantedAt, expiresAt, evidenceRef
- Связи: через objectRef / foreignKey

**ConsentConflict**
- Поля: id, consentA, consentB, conflictType, severity, resolution, resolvedBy
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m54/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-54.json`
- Коллекции: `consents`, `privacyPolicies`, `consentConflicts`, `consentRequests`, `accessReviews`, `revocations`
...
- **Sources:** M34 Consents, M17 Security
- **Consumers:** M38 Audit, M35 Policies
