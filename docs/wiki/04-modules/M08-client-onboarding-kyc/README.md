# M08 Client Onboarding and KYC KYB AML

## 1. Назначение модуля
Онбординг новых клиентов, KYC/KYB/AML проверки.
...
**Value outcomes:**
- Structured client intake with configurable forms
- Automated screening (sanctions, PEP, adverse media)
- Risk-scored onboarding cases with evidence packs
...
**OnboardingCase**
- Поля: id, clientName, type, status, riskScore, assignee, startDate, completedDate, evidencePackId
- Связи: через objectRef / foreignKey

**ScreeningCheck**
- Поля: id, caseId, checkType, provider, result, matchCount, reviewedBy, reviewedAt
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m08/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-08.json`
- Коллекции: `onboardingCases`, `screeningChecks`, `intakeForms`, `evidencePacks`
...
- **Sources:** External screening APIs
- **Consumers:** M17 Security, M38 Audit
