# M15 Secure Communications and Client Requests

## 1. Назначение модуля
Защищённая коммуникация с клиентами и внутри команды.
...
**Value outcomes:**
- Encrypted client-advisor communication
- Structured client request lifecycle
...
**CommThread**
- Поля: id, subject, participants[], status, priority, createdAt, lastMessageAt, slaPolicy
- Связи: через objectRef / foreignKey

**CommMessage**
- Поля: id, threadId, senderId, body, attachments[], sentAt, readBy[]
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m15/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-15.json`
- Коллекции: `commThreads`, `commMessages`, `commAttachments`, `commParticipants`, `commSlaPolicies`, `commThreadPins`
...
- **Sources:** M55 Portal (client requests)
