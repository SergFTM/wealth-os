# M39 Data Quality and Exceptions

## 1. Назначение модуля
Мониторинг качества данных и управление исключениями.
...
- Centralized exception triage and resolution
...
**DqRule**
- Поля: id, name, collection, field, ruleType, threshold, severity, active
- Связи: через objectRef / foreignKey

**DqException**
- Поля: id, ruleId, recordRef, expectedValue, actualValue, severity, status, assignee
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m39/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-39.json`
- Коллекции: `dqRules`, `dqRuns`, `dqMetrics`, `dqExceptions`, `dqConflicts`, `dqReconChecks`, `dqSyncJobs`, `dataQualityIssues`
...
- **Sources:** M14 Integrations, M21 Reconciliation
- **Consumers:** M48 Exception Center
