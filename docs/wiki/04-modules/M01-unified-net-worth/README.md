# M01 Unified Net Worth

## 1. Назначение модуля
Агрегирует все активы (liquid, illiquid, private, real estate, personal) и обязательства клиента/группы в единый баланс.
...
**Value outcomes:**
- Single source of truth for total wealth
- Cross-entity / cross-custodian aggregation
...
**NetWorthSnapshot**
- Поля: id, householdId, asOf, totalAssets, totalLiabilities, netWorth, currency, breakdown[]
- Связи: через objectRef / foreignKey

**AssetAllocation**
- Поля: id, snapshotId, assetClass, subClass, marketValue, percentage, sourceRef
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m01/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-01.json`
- Коллекции: `netWorthSnapshots`, `assetAllocations`, `liabilityItems`, `valuationOverrides`
...
- **Sources:** M14 Integrations, M03 Performance
- **Consumers:** M19 Reporting, M55 Portal
- **Governance:** M46 Data Governance
