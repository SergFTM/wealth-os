# M34 Consents and Data Sharing

## 1. Назначение модуля
Управление согласиями клиентов на обработку данных.
...
- Automated expiry and renewal workflows
...
**Consent**
- Поля: id, clientId, purpose, scope, grantedAt, expiresAt, status, evidenceRef
...
- `POST /api/actions/m34/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-34.json`
- Коллекции: `consents`, `consentPurposes`, `consentRevocations`
...
- **Sources:** M08 Onboarding
- **Consumers:** M54 Consent Center, M35 Policies
