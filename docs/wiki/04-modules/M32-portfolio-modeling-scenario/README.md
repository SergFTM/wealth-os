# M32 Portfolio Modeling and Scenario Analysis

## 1. Назначение модуля
Моделирование портфелей и сценарный анализ.
...
**Value outcomes:**
- What-if portfolio scenario analysis
- Mean-variance optimization and efficient frontier
- Proposed vs current allocation comparison
...
**Scenario**
- Поля: id, name, type, assumptions[], proposedAllocation[], expectedReturn, expectedRisk, sharpe
- Связи: через objectRef / foreignKey

**PlanningRun**
- Поля: id, scenarioId, runDate, method, result, status
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m32/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-32.json`
- Коллекции: `scenarios`, `planningRuns`, `assumptions`, `planActualLinks`
...
- **Sources:** M03 Performance, M10 Risk
- **Consumers:** M09 IPS, M24 Notes
- **Governance:** —
