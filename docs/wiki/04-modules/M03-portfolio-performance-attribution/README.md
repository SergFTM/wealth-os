# M03 Portfolio Performance and Attribution

## 1. Назначение модуля
Расчёт доходности портфелей (TWR, MWR), атрибуция, сравнение с бенчмарками.
...
**Value outcomes:**
- Accurate TWR/MWR across custodians
- Multi-level attribution (asset class, sector, manager)
- Benchmark comparison with custom composites
...
**PerformanceSeries**
- Поля: id, portfolioId, period, twr, mwr, benchmarkReturn, alpha, inception, asOf
- Связи: через objectRef / foreignKey

**AttributionResult**
- Поля: id, seriesId, level, factor, allocation, selection, interaction, total
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m03/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-03.json`
- Коллекции: `performanceSeries`, `benchmarks`, `attributionResults`, `composites`
...
- **Sources:** M14 Integrations, M01 Net Worth
- **Consumers:** M19 Reporting, M09 IPS
