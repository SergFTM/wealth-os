# M36 Case Management and Service Tickets

## 1. Назначение модуля
Управление кейсами и тикетами клиентских запросов.
...
- SLA compliance tracking with escalation
- Case templates for common request types
...
**Case**
- Поля: id, title, type, clientId, assignee, priority, status, slaDeadline, createdAt, resolvedAt
- Связи: через objectRef / foreignKey

**CaseComment**
- Поля: id, caseId, author, body, isInternal, createdAt
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m36/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-36.json`
- Коллекции: `cases`, `caseComments`, `caseLinks`, `caseReports`, `caseTemplates`
...
- **Consumers:** M22 Task Board, M15 Communications
