# M29 Entity Management and Corporate Records

## 1. Назначение модуля
Управление юридическими лицами и корпоративными записями.
...
**Value outcomes:**
- Hierarchical entity structure visualization
- Corporate filing and compliance tracking
- Registered agent and officer management
...
**Entity**
- Поля: id, name, type, jurisdiction, parentId, status, incorporationDate, taxId
- Связи: через objectRef / foreignKey

**EntityFiling**
- Поля: id, entityId, type, dueDate, filedDate, status, documentRef
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m29/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-29.json`
- Коллекции: `entities`, `entityFilings`, `entityOfficers`
...
- **Consumers:** M47 Ownership, M12 Trusts
