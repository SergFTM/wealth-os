# M43 Multi Currency and FX

## 1. Назначение модуля
Управление мультивалютными операциями и FX.
...
**Value outcomes:**
- Automated FX rate feeds and historical rates
- Multi-currency P&L with translation adjustments
- Configurable reporting currency per entity
...
**FxRate**
- Поля: id, baseCurrency, quoteCurrency, rate, date, source, type
- Связи: через objectRef / foreignKey

**CurrencyConversion**
- Поля: id, fromCurrency, toCurrency, amount, convertedAmount, rate, date, purpose
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m43/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-43.json`
- Коллекции: `fxRates`, `currencyConversions`, `reportingCurrencySettings`
...
- **Sources:** M41 Market Data
- **Consumers:** M01 Net Worth, M02 GL, M03 Performance
