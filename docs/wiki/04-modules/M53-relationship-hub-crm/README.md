# M53 Relationship Hub and CRM

## 1. Назначение модуля
CRM для wealth management: отношения, coverage, VIP.
...
**Value outcomes:**
- 360-degree client relationship view
- Interaction logging and coverage tracking
- VIP client management with priority alerts
...
### Маршруты
- `/m/relationships`
- `/m/relationships/list`
- `/m/relationships/relationship/[id]`
...
**Relationship**
- Поля: id, type, primaryContact, entities[], rm, status, tier, lastInteraction
- Связи: через objectRef / foreignKey

**Interaction**
- Поля: id, relationshipId, type, date, participants[], summary, followUps[], sentiment
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m53/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-53.json`
- Коллекции: `relRelationships`, `relInteractions`, `relHouseholds`, `relCoverage`, `relInitiatives`, `relVipViews`
...
- **Sources:** M08 Onboarding, M15 Communications
- **Consumers:** M55 Portal, M19 Reporting
- **Governance:** M34 Consents
