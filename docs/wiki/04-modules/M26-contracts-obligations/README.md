# M26 Contracts and Obligations

## 1. Назначение модуля
Учёт договоров и обязательств с отслеживанием сроков.
...
**Obligation**
- Поля: id, title, type, counterparty, startDate, endDate, value, status, renewalDate, linkedDocs[]
...
- `POST /api/actions/m26/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-26.json`
- Коллекции: `obligations`, `documentLinks`
...
- **Sources:** M05 Documents, M25 Vendors
- **Consumers:** M23 Calendar, M38 Audit
