# M42 Partnership Accounting

## 1. Назначение модуля
Учёт партнёрств и распределение доходов между участниками.
...
**Value outcomes:**
- Partnership capital account management
- Automated income/loss allocation calculations
- K-1 and tax reporting preparation
...
**Partnership**
- Поля: id, name, type, partners[], fiscalYearEnd, status
- Связи: через objectRef / foreignKey

**PartnerCapitalAccount**
- Поля: id, partnershipId, partnerId, balance, contributions, distributions, allocations
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m42/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-42.json`
- Коллекции: `partnerships`, `partnerCapitalAccounts`, `partnerAllocations`, `partnerK1s`
...
- **Sources:** M02 GL, M04 Private Markets
