# M12 Trust and Estate Administration

## 1. Назначение модуля
Администрирование трастов и наследственных структур.
...
**Value outcomes:**
- Comprehensive trust record management
- Beneficiary and distribution tracking
- Trust event and power administration
...
**Trust**
- Поля: id, name, type, jurisdiction, settlorId, trusteeIds[], beneficiaryIds[], status, inceptionDate
- Связи: через objectRef / foreignKey

**TrustDistribution**
- Поля: id, trustId, beneficiaryId, amount, type, date, approvedBy, status
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m12/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-12.json`
- Коллекции: `trusts`, `trustees`, `beneficiaries`, `trustDistributions`, `trustPowers`, `trustEvents`, `trustCalendars`
...
- **Sources:** M01 Net Worth, M05 Documents
- **Consumers:** M19 Reporting, M38 Audit
