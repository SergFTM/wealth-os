# M27 Insurance and Policies

## 1. Назначение модуля
Управление страховыми полисами и claims.
...
**Value outcomes:**
- Comprehensive insurance policy registry
- Claims tracking and resolution
- Coverage gap analysis and renewal management
...
**InsurancePolicy**
- Поля: id, type, provider, policyNumber, coverageAmount, premium, startDate, endDate, status
- Связи: через objectRef / foreignKey

**InsuranceClaim**
- Поля: id, policyId, claimDate, amount, description, status, resolution
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m27/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-27.json`
- Коллекции: `insurancePolicies`, `insuranceClaims`, `insuranceRenewals`
...
- **Consumers:** M01 Net Worth, M23 Calendar
