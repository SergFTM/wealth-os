# M23 Calendar and Meetings

## 1. Назначение модуля
Календарь встреч, дедлайнов и напоминаний.
...
**Value outcomes:**
- Unified calendar aggregating deadlines from all modules
- Meeting scheduling with agenda and notes
...
**CalendarEvent**
- Поля: id, title, type, startDate, endDate, participants[], module, objectRef, location
- Связи: через objectRef / foreignKey

**MeetingNote**
- Поля: id, eventId, content, decisions[], actionItems[], createdBy
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m23/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-23.json`
- Коллекции: `calendarEvents`, `meetingNotes`, `reminders`
...
- **Sources:** All modules (deadlines)
- **Consumers:** M07 Workflow, M24 Notes
- **Governance:** —
