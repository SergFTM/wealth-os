# M37 External Sharing and Secure Links

## 1. Назначение модуля
Безопасный обмен документами с внешними сторонами.
...
**ExportShare**
- Поля: id, documentRef, recipientEmail, token, expiresAt, watermark, accessCount, createdBy
- Связи: через objectRef / foreignKey

**ExportRun**
- Поля: id, templateId, runDate, format, status, outputRef, schedule
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m37/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-37.json`
- Коллекции: `exportTemplates`, `exportRuns`, `exportFiles`, `exportShares`, `exportPacks`, `exportSchedules`
...
- **Sources:** M05 Documents, M19 Reporting
- **Consumers:** M38 Audit
