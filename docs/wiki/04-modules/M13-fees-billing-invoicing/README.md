# M13 Fees Billing and Invoicing

## 1. Назначение модуля
Биллинг, расчёт комиссий и управление счетами.
...
**Value outcomes:**
- Automated fee calculation based on AUM/performance
- Configurable fee schedules and contracts
- Revenue analytics and AR aging reports
...
**FeeSchedule**
- Поля: id, name, type, tiers[], minimumFee, currency, effectiveDate
- Связи: через objectRef / foreignKey

**FeeInvoice**
- Поля: id, clientId, period, amount, status, dueDate, paidDate, lineItems[]
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m13/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-13.json`
- Коллекции: `feeSchedules`, `feeContracts`, `feeRuns`, `feeInvoices`, `feePolicies`
...
- **Sources:** M01 Net Worth, M03 Performance
- **Consumers:** M02 GL, M06 Payments
