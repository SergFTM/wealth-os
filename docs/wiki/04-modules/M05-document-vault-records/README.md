# M05 Document Vault and Records

## 1. Назначение модуля
Централизованное хранилище документов с версионированием и контролем доступа.
...
- Evidence pack assembly for audits
- Role-based access and client-safe sharing
...
**Document**
- Поля: id, title, type, entityRef, uploadedBy, uploadedAt, currentVersion, tags[], status
- Связи: через objectRef / foreignKey

**DocumentVersion**
- Поля: id, documentId, version, fileRef, uploadedBy, uploadedAt, notes
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m05/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-05.json`
- Коллекции: `documents`, `documentVersions`, `docTags`, `docShares`
...
- **Sources:** All modules (attachments)
- **Consumers:** M19 Reporting, M38 Audit, M55 Portal
