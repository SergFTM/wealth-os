# M16 AI Copilot and Narratives

## 1. Назначение модуля
AI-ассистент для генерации текстов, объяснений и triage.
...
**Value outcomes:**
- Context-aware explanations of financial data
- Automated draft generation for reports and letters
- Intelligent triage and prioritization suggestions
...
**AiNarrative**
- Поля: id, mode, prompt, response, sources[], confidence, asOf, module, objectRef, lang
- Связи: через objectRef / foreignKey

**AiPolicy**
- Поля: id, name, guardrails[], allowedModes[], clientSafeRules, active
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m16/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-16.json`
- Коллекции: `aiNarratives`, `aiDrafts`, `aiFeedback`, `aiPolicies`, `aiEvents`, `aiTriageItems`
...
- **Sources:** All modules (context)
- **Consumers:** M19 Reporting, M55 Portal
- **Governance:** M34 Consents, M35 Policies
