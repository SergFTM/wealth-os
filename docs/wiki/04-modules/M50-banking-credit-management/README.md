# M50 Banking and Credit Management

## 1. Назначение модуля
Управление банковскими отношениями и кредитными линиями.
...
**Value outcomes:**
- Credit facility and loan lifecycle management
- Automated covenant compliance monitoring
- Collateral and LTV tracking with alerts
...
**CreditFacility**
- Поля: id, bankId, type, limit, drawn, available, maturityDate, rate, covenants[], status
- Связи: через objectRef / foreignKey

**CreditCovenant**
- Поля: id, facilityId, name, type, threshold, currentValue, compliant, testedAt
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m50/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-50.json`
- Коллекции: `creditFacilities`, `creditLoans`, `creditCovenants`, `creditCollateral`, `creditPayments`, `creditSchedules`, `creditCalendar`, `creditBanks`
...
- **Sources:** M01 Net Worth, M20 Liquidity
- **Consumers:** M02 GL, M10 Risk
- **Governance:** M26 Contracts
