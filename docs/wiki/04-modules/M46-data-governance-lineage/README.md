# M46 Data Governance and Lineage

## 1. Назначение модуля
Data governance: lineage, quality scoring, «why this number».
...
- Data quality scoring across all collections
- "Why this number" drill-through for any data point
...
**DataLineageNode**
- Поля: id, collection, recordId, field, sourceSystem, transformations[], asOf
- Связи: через objectRef / foreignKey

**DataQualityScore**
- Поля: id, collection, dimension, score, issues, lastChecked
- Связи: через objectRef / foreignKey
...
- `POST /api/actions/m46/<actionKey>`
  - Вход: payload JSON
...
## 13. Demo Data
### Seed данные
- Файл: `src/db/seed/seed-module-46.json`
- Коллекции: `dataLineageNodes`, `dataLineageEdges`, `dataQualityScores`
...
- **Sources:** M14 Integrations, M39 DQ
- **Consumers:** All modules (lineage)
- **Governance:** M40 MDM
